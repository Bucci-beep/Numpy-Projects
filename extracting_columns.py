{
 "cells": [
  ...
  },
  {
   ...
   "source": [
    "reshaped_array[:,0] # extracting the first column"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": 13,
   "id": "57c1d2bb-eed0-4b22-8ed6-1bb2461effa2",
   "metadata": {},
   "outputs": [
    {
     "data": {
   ...
   "source": [
    "reshaped_array[:,4] # extracting the last column"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "8116835a-cfe7-47d7-a3b0-5826b68b995d",
   "metadata": {},
   "outputs": [],
   "source": []
  }
